...
namespace GraduationProjectAPI.Colorization
{
    ...
    /// </summary>
    public unsafe class Functional
    {
        ...
        public Tensor AvgPool2d(Tensor x,
                                       int kernelH,
                                       int kernelW,
                                       int strideY,
                                       int strideX,
        ...
        /// <returns>Tensor.</returns>
        public Tensor BatchNorm2d_(Tensor x, Tensor mean, Tensor @var, Tensor weight, Tensor bias)
        {
        ...
        /// <returns>Tensor.</returns>
        public Tensor EltwiseMulScalar_(Tensor x, float s)
        {
            var px = x.Data;
        ...
        /// <returns>Tensor.</returns>
        public Tensor MaxPool2d(Tensor x,
                                       int kernelH,
                                       int kernelW,
                                       int strideY,
                                       int strideX,
        ...
        /// <param name="x">Input tensor.</param>
        /// <returns>Tensor.</returns>
        public Tensor PixelShuffle(Tensor x)
        {
        ...
        /// <returns>Tensor.</returns>
        public Tensor Plus_(Tensor a, Tensor b)
        {
            var pa = a.Data;
        ...
        /// <param name="b">Tensor B.</param>
        /// <returns>Tensor.</returns>
        public Tensor RestrictedCat2d(Tensor a, Tensor b)
        {
        ...
        /// <param name="x">Input tensor.</param>
        /// <returns>Tensor.</returns>
        public Tensor Sigmoid_(Tensor x)
        {
            for (float* px = x.Data; px < x.Data + x.Numel; ++px)
            {
        ...
        /// <returns>Tensor.</returns>
        public Tensor Softmax2d(Tensor input)
        {
